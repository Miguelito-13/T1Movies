  ...
  <div class="movies-list-container">
    ...
    <div class="tab-content" id="nav-tabContent">
      ...
      <div class="tab-pane fade show active" id="nav-genre-all" role="tabpanel" aria-labelledby="nav-genre-all-tab">
        <?php
        $sql = "SELECT * FROM movies WHERE ACTIVE = '1' ORDER BY MOVIE_TITLE ASC";
      ...
      <div class="tab-pane fade" id="nav-genre-action" role="tabpanel" aria-labelledby="nav-genre-action-tab">
        <?php
        $sql = "SELECT * from genre LEFT JOIN movies ON movies.MOVIE_ID = genre.MOVIE_ID WHERE genre.ACTION = '1' AND movies.ACTIVE = '1'";
        $res = mysqli_query($link,  $sql);
        if (mysqli_num_rows($res) > 0) {
          while ($row = mysqli_fetch_assoc($res)) { ?>
            <div class="row justify-content-center custom-table mx-auto py-3">
          ...
          <div class="row justify-content-center custom-table mx-auto py-5">
            <h1>Action Movies Coming Soon...</h1>
          </div>
        <?php
        } ?>
      </div>
      ...
      <div class="tab-pane fade" id="nav-genre-adventure" role="tabpanel" aria-labelledby="nav-genre-adventure-tab">
        <?php
        $sql = "SELECT * from genre LEFT JOIN movies ON movies.MOVIE_ID = genre.MOVIE_ID WHERE genre.ADVENTURE = '2' AND movies.ACTIVE = '1'";
        $res = mysqli_query($link,  $sql);
        if (mysqli_num_rows($res) > 0) {
          while ($row = mysqli_fetch_assoc($res)) { ?>
            <div class="row justify-content-center custom-table mx-auto py-3">
          ...
          <div class="row justify-content-center custom-table mx-auto py-5">
            <h1>Adventure Movies Coming Soon...</h1>
          </div>
        <?php
        } ?>
      </div>
      ...
      <div class="tab-pane fade" id="nav-genre-animation" role="tabpanel" aria-labelledby="nav-genre-animation-tab">
        <?php
        $sql = "SELECT * from genre LEFT JOIN movies ON movies.MOVIE_ID = genre.MOVIE_ID WHERE genre.ANIMATION = '3' AND movies.ACTIVE = '1'";
        $res = mysqli_query($link,  $sql);
        if (mysqli_num_rows($res) > 0) {
          while ($row = mysqli_fetch_assoc($res)) { ?>
            <div class="row justify-content-center custom-table mx-auto py-3">
          ...
          <div class="row justify-content-center custom-table mx-auto py-5">
            <h1>Animation Movies Coming Soon...</h1>
          </div>
        <?php
        } ?>
      </div>
      ...
      <div class="tab-pane fade" id="nav-genre-comedy" role="tabpanel" aria-labelledby="nav-genre-comedy-tab">
        <?php
        $sql = "SELECT * from genre LEFT JOIN movies ON movies.MOVIE_ID = genre.MOVIE_ID WHERE genre.COMEDY = '4' AND movies.ACTIVE = '1'";
        $res = mysqli_query($link,  $sql);
        if (mysqli_num_rows($res) > 0) {
          while ($row = mysqli_fetch_assoc($res)) { ?>
            <div class="row justify-content-center custom-table mx-auto py-3">
          ...
          <div class="row justify-content-center custom-table mx-auto py-5">
            <h1>Comedy Movies Coming Soon...</h1>
          </div>
        <?php
        } ?>
      </div>
      ...
      <div class="tab-pane fade" id="nav-genre-drama" role="tabpanel" aria-labelledby="nav-genre-drama-tab">
        <?php
        $sql = "SELECT * from genre LEFT JOIN movies ON movies.MOVIE_ID = genre.MOVIE_ID WHERE genre.DRAMA = '5' AND movies.ACTIVE = '1'";
        $res = mysqli_query($link,  $sql);
        if (mysqli_num_rows($res) > 0) {
          while ($row = mysqli_fetch_assoc($res)) { ?>
            <div class="row justify-content-center custom-table mx-auto py-3">
          ...
          <div class="row justify-content-center custom-table mx-auto py-5">
            <h1>Drama Movies Coming Soon...</h1>
          </div>
        <?php
        } ?>
      </div>
      ...
      <div class="tab-pane fade" id="nav-genre-family" role="tabpanel" aria-labelledby="nav-genre-family-tab">
        <?php
        $sql = "SELECT * from genre LEFT JOIN movies ON movies.MOVIE_ID = genre.MOVIE_ID WHERE genre.FAMILY = '6' AND movies.ACTIVE = '1'";
        $res = mysqli_query($link,  $sql);
        if (mysqli_num_rows($res) > 0) {
          while ($row = mysqli_fetch_assoc($res)) { ?>
            <div class="row justify-content-center custom-table mx-auto py-3">
          ...
          <div class="row justify-content-center custom-table mx-auto py-5">
            <h1>Family Movies Coming Soon...</h1>
          </div>
        <?php
        } ?>
      </div>
      ...
      <div class="tab-pane fade" id="nav-genre-fantasy" role="tabpanel" aria-labelledby="nav-genre-fantasy-tab">
        <?php
        $sql = "SELECT * from genre LEFT JOIN movies ON movies.MOVIE_ID = genre.MOVIE_ID WHERE genre.FANTASY = '7' AND movies.ACTIVE = '1'";
        $res = mysqli_query($link,  $sql);
        if (mysqli_num_rows($res) > 0) {
          while ($row = mysqli_fetch_assoc($res)) { ?>
            <div class="row justify-content-center custom-table mx-auto py-3">
          ...
          <div class="row justify-content-center custom-table mx-auto py-5">
            <h1>Fantasy Movies Coming Soon...</h1>
          </div>
        <?php
        } ?>
      </div>
      ...
      <div class="tab-pane fade" id="nav-genre-horror" role="tabpanel" aria-labelledby="nav-genre-horror-tab">
        <?php
        $sql = "SELECT * from genre LEFT JOIN movies ON movies.MOVIE_ID = genre.MOVIE_ID WHERE genre.HORROR = '8' AND movies.ACTIVE = '1'";
        $res = mysqli_query($link,  $sql);
        if (mysqli_num_rows($res) > 0) {
          while ($row = mysqli_fetch_assoc($res)) { ?>
            <div class="row justify-content-center custom-table mx-auto py-3">
          ...
          <div class="row justify-content-center custom-table mx-auto py-5">
            <h1>Horror Movies Coming Soon...</h1>
          </div>
        <?php
        } ?>
      </div>
      ...
      <div class="tab-pane fade" id="nav-genre-musical" role="tabpanel" aria-labelledby="nav-genre-musical-tab">
        <?php
        $sql = "SELECT * from genre LEFT JOIN movies ON movies.MOVIE_ID = genre.MOVIE_ID WHERE genre.MUSICAL = '9' AND movies.ACTIVE = '1'";
        $res = mysqli_query($link,  $sql);
        if (mysqli_num_rows($res) > 0) {
          while ($row = mysqli_fetch_assoc($res)) { ?>
            <div class="row justify-content-center custom-table mx-auto py-3">
          ...
          <div class="row justify-content-center custom-table mx-auto py-5">
            <h1>Musical Movies Coming Soon...</h1>
          </div>
        <?php
        } ?>
      </div>
      ...
      <div class="tab-pane fade" id="nav-genre-mystery" role="tabpanel" aria-labelledby="nav-genre-mystery-tab">
        <?php
        $sql = "SELECT * from genre LEFT JOIN movies ON movies.MOVIE_ID = genre.MOVIE_ID WHERE genre.MYSTERY = '10' AND movies.ACTIVE = '1'";
        $res = mysqli_query($link,  $sql);
        if (mysqli_num_rows($res) > 0) {
          while ($row = mysqli_fetch_assoc($res)) { ?>
            <div class="row justify-content-center custom-table mx-auto py-3">
          ...
          <div class="row justify-content-center custom-table mx-auto py-5">
            <h1>Mystery Movies Coming Soon...</h1>
          </div>
        <?php
        } ?>
      </div>
      ...
      <div class="tab-pane fade" id="nav-genre-romance" role="tabpanel" aria-labelledby="nav-genre-romance-tab">
        <?php
        $sql = "SELECT * from genre LEFT JOIN movies ON movies.MOVIE_ID = genre.MOVIE_ID WHERE genre.ROMANCE = '11' AND movies.ACTIVE = '1'";
        $res = mysqli_query($link,  $sql);
        if (mysqli_num_rows($res) > 0) {
          while ($row = mysqli_fetch_assoc($res)) { ?>
            <div class="row justify-content-center custom-table mx-auto py-3">
          ...
          <div class="row justify-content-center custom-table mx-auto py-5">
            <h1>Romance Movies Coming Soon...</h1>
          </div>
        <?php
        } ?>
      </div>
      ...
      <div class="tab-pane fade" id="nav-genre-sci" role="tabpanel" aria-labelledby="nav-genre-sci-tab">
        <?php
        $sql = "SELECT * from genre LEFT JOIN movies ON movies.MOVIE_ID = genre.MOVIE_ID WHERE genre.SCI_FI = '12' AND movies.ACTIVE = '1'";
        $res = mysqli_query($link,  $sql);
        if (mysqli_num_rows($res) > 0) {
          while ($row = mysqli_fetch_assoc($res)) { ?>
            <div class="row justify-content-center custom-table mx-auto py-3">
          ...
          <div class="row justify-content-center custom-table mx-auto py-5">
            <h1>Sci-Fi Movies Coming Soon...</h1>
          </div>
        <?php
        } ?>
      </div>
      ...
      <div class="tab-pane fade" id="nav-genre-thriller" role="tabpanel" aria-labelledby="nav-genre-thriller-tab">
        <?php
        $sql = "SELECT * from genre LEFT JOIN movies ON movies.MOVIE_ID = genre.MOVIE_ID WHERE genre.THRILLER = '13' AND movies.ACTIVE = '1'";
        $res = mysqli_query($link,  $sql);
        if (mysqli_num_rows($res) > 0) {
          while ($row = mysqli_fetch_assoc($res)) { ?>
            <div class="row justify-content-center custom-table mx-auto py-3">
          ...
          <div class="row justify-content-center custom-table mx-auto py-5">
            <h1>Thriller Movies Coming Soon...</h1>
          </div>
        <?php
        } ?>
      </div>
