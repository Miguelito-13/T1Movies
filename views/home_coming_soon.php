...
<div class="col-md-12 mb-5 custom-general-holder">
    ...
    <div class="glideCS glide-2" id="glideCS">
        <div class="glide__track" data-glide-el="track">
            <ul class="glide__slides list-unstyled">     
                <?php
                $sql = "SELECT * FROM movies WHERE ACTIVE = '1' ORDER BY MOVIE_TITLE ASC LIMIT 20";
...
<script>
    ...
    const glide2 = new Glide('.glide-2', config2);
    glide2.mount();
</script>
<script>
    import Glide, { Swipe } from '@glidejs/glide/dist/glide.modular.esm'

    new Glide('#glideCS').mount({ Swipe })
